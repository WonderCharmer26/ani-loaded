...
export default function RecommendationInput({
  ...
  return (
    <form
      ...
      className="group relative w-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#0d1117] p-2 shadow-[0_18px_60px_rgba(0,0,0,0.45)] transition-all duration-300 focus-within:border-[#3CB4FF]/55 focus-within:shadow-[0_0_0_1px_rgba(60,180,255,0.22),0_18px_60px_rgba(7,18,32,0.7)]"
    >
      ...
      <div className="relative flex items-center gap-3 rounded-[1.6rem] border border-white/6 bg-[linear-gradient(135deg,rgba(7,12,20,0.96),rgba(18,25,35,0.92))] px-4 py-3">
        ...
        <label className="flex min-w-0 flex-1 items-center gap-3 rounded-full border border-transparent bg-white/4 px-4 py-2.5 transition-colors duration-300 group-focus-within:border-[#3CB4FF]/20 group-focus-within:bg-white/6">
          ...
          <input
            ...
            className="w-full bg-transparent text-[0.98rem] text-slate-100 placeholder:text-slate-500 outline-none disabled:cursor-not-allowed"
          />
        </label>
        ...
        <button
          ...
          className="relative flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#8edcff]/25 bg-[linear-gradient(135deg,#1b6fa6,#3CB4FF)] text-white shadow-[0_10px_24px_rgba(60,180,255,0.28)] transition duration-300 before:absolute before:inset-0 before:bg-[linear-gradient(135deg,rgba(255,255,255,0.36),transparent_45%)] before:opacity-70 hover:scale-[1.03] hover:shadow-[0_12px_28px_rgba(60,180,255,0.38)] focus:outline-none focus:ring-2 focus:ring-[#3CB4FF]/50 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:scale-100 disabled:hover:shadow-[0_10px_24px_rgba(60,180,255,0.28)]"
          aria-label="Search"
        >
